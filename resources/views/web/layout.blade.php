...
<div class="container">
	...
	<!-- social -->
		<div class="col-md-4 col-md-push-8">
			<x-social-Links></x-socia-lLinks>
		</div>
	<!-- /social -->
        <!-- copyright -->
        <div class="col-md-8 col-md-pull-4">
            <div class="footer-copyright">
                <span>&copy; Copyright 2021. All Rights Reserved. | Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#">CloudyTeck</a></span>
            </div>
        </div>
        <!-- /copyright -->
